...
if (!exists("params")) params <- list(data_dir = ".")
data_dir <- params$data_dir
find_file <- function(name) file.path(data_dir, name)

price_file <- read_csv("project4/ev-power-JreamIT/data/av-energy-price-2021-2023.csv")
ev_file <- read_csv("project4/ev-power-JreamIT/data/ev-registrations-by-state-2023.csv")
